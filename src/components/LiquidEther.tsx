...
export const LiquidEther: React.FC<LiquidEtherProps> = ({
  ...
  useEffect(() => {
    ...
    class AutoDriver {
      ...
      constructor(mouse: MouseClass, manager: WebGLManager, opts: AutoDriverOpts) {
        this.mouse = mouse;
...
`;
    ...
    class Advection extends ShaderPass {
      ...
      updateAdvection({ dt, isBounce, BFECC }: { dt: number; isBounce: boolean; BFECC: boolean }) {
    ...
    class ExternalForce extends ShaderPass {
      ...
      initForce(simProps: ExternalForceProps) {
      ...
      updateForce(props: { mouse_force: number; cursor_size: number; cellScale: THREE.Vector2 }) {
        ...
        const uniforms = (this.mouseMesh.material as any).uniforms;
    ...
    class Viscous extends ShaderPass {
      ...
      updateViscous({ viscous, iterations, dt }: { viscous: number; iterations: number; dt: number }) {
    ...
    class Pressure extends ShaderPass {
      ...
      updatePressure({ vel, pressure }: { vel: THREE.WebGLRenderTarget; pressure: THREE.WebGLRenderTarget }) {
        this.uniforms!.velocity.value = vel.texture;
